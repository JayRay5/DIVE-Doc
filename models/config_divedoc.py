...
def get_original_decoder_config():
    gemma_config = GemmaConfig( hidden_size = 2048,
                                intermediate_size = 16384,
                                model_type = "gemma",
                                num_attention_heads = 8,
                                num_hidden_layers = 18,
...
def get_model_config(   visual_encoder_type: Literal["swinpam","siglip80m"],
                        image_size = [2560,1920],
                        sequence_mapping_layer_type = "bilinear",
                        student_fmap_dim =(80,60),
                        student_embedding_dim = 1024,
